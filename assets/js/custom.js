...
document.addEventListener("DOMContentLoaded", function () {
    const food_grocery_store_progressBar =
        document.getElementById("food_grocery_store_elemento_progress_bar");
    if (!food_grocery_store_progressBar) return;
    window.addEventListener("scroll", function () {
        const food_grocery_store_scrollTop =
            document.documentElement.scrollTop || document.body.scrollTop;
        const food_grocery_store_height =
            document.documentElement.scrollHeight -
            document.documentElement.clientHeight;
        const food_grocery_store_scrolled =
            (food_grocery_store_scrollTop / food_grocery_store_height) * 100;
        food_grocery_store_progressBar.style.width =
            food_grocery_store_scrolled + "%";
    });
});