...
* Added show/hide sticky header in Top header section.
* Updated pot file.

= 1.1.3 =
* Added footer social icon alignment option.
* Resolved error for copyright alignment.
* Resolved error for topbar show /hide plugins option.
* Added css for wishlist page.
...
Slider Image,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1092786

Slider Image,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/668450
