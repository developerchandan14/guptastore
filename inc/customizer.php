...
function food_grocery_store_customize_register( $wp_customize ) {
	...
	// Progress Bar
	$wp_customize->add_setting( 'food_grocery_store_progress_bar', array(
		'default'           => 0, 
		'transport'         => 'refresh',
		'sanitize_callback' => 'food_grocery_store_switch_sanitization',
	));
	...
	$wp_customize->add_control(
		new Food_Grocery_Store_Toggle_Switch_Custom_Control(
			$wp_customize,
			'food_grocery_store_progress_bar',
			array(
				'label'   => esc_html__( 'Show / Hide Progress Bar', 'food-grocery-store' ),
				'section' => 'food_grocery_store_left_right',
			)
		)
	);
