	...
	<div class="tab-sec">
		...
		<div id="lite_theme" class="tabcontent">
			<div class="lite-theme-tab" style="<?php echo esc_attr($food_grocery_store_plugin_custom_css); ?>">
				...
				<hr class="h3hr">
				<p><?php esc_html_e('The Food Grocery Store theme is a thoughtfully designed solution for businesses involved in online grocery shopping, including organic food markets, supermarkets, and food companies. Perfect for showcasing a variety of products like vegetables, fruits, beverages, and more, this theme elevates your online presence with its responsive and customizable layout. With options tailored for food delivery services, it\'s an excellent choice for establishing a powerful online marketplace for all your grocery needs, whether you\'re a vegetables vendor, a merchant of organic tea, or a bakery products supplier. The theme presents all items from dairy products to seafood, and even pet food delivery in a well-organized and visually appealing manner, ensuring easy navigation for customers. Thanks to its retina-ready design, your offerings stand out, while the professional layout features engaging elements like sliders and Call To Action (CTA) buttons to capture customer interest. Built on the robust Bootstrap framework, this theme effortlessly manages heavy traffic without sacrificing performance. Additionally, the SEO-friendly structure of the theme is designed to boost your visibility online, drawing more traffic to your digital storefront. With WPML and RTL compatibility, it\’s also prepared for global audiences through easy translation options. Whether you\'re selling agricultural products, protective kits, or natural and organic medicinal herbs, this theme provides an optimal platform for retail in the e-commerce marketplace.','food-grocery-store'); ?></p>
				<div class="lite-info">
			...
			<div class="bundle-info">
				<div class="col-left-pro">
			    	...
			    	<div class="feature">
			    		...
			    		<p><img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/tick.png" alt="" /><?php esc_html_e('500+ Premium Themes & 5+ Plugins.', 'food-grocery-store'); ?></p>
			    	...
			    	<p><?php esc_html_e('Upgrade now and give your website the professional edge it deserves, all at an unbeatable price of $119!', 'food-grocery-store'); ?></p>
			    	<div class="pro-links">
		...
		<div class="sshot-section">
	    	...
	    	<div class="bundle-banner">
	    		...
	    		<div class="bundle-text">
					...
					<h4><?php esc_html_e('Get Access to 500+ Premium WordPress Themes At Just $119','food-grocery-store'); ?></h4>
					<div class="bundle-button">
			  			<a href="<?php echo esc_url( 'https://www.vwthemes.com/discount/FREEBREF?redirect=/products/wp-theme-bundle'); ?>" target="_blank"><?php esc_html_e('Get 20% OFF On Bundle', 'food-grocery-store'); ?></a>
			  		</div>
		  		</div>
